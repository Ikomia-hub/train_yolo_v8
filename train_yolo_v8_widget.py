...
from train_yolo_v8.train_yolo_v8_process import TrainYoloV8Param
...
# --------------------
class TrainYoloV8Widget(core.CWorkflowTaskWidget):

    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = TrainYoloV8Param()
        else:
...
# --------------------
class TrainYoloV8WidgetFactory(dataprocess.CWidgetFactory):

    def __init__(self):
        dataprocess.CWidgetFactory.__init__(self)
        # Set the name of the process -> it must be the same as the one declared in the process factory class
        self.name = "train_yolo_v8"

    def create(self, param):
        # Create widget object
        return TrainYoloV8Widget(param, None)
